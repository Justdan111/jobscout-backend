...
// ToModel converts a scored RawJob into a stored Job.
func (r RawJob) ToModel(score int, reason string, elig models.Eligibility) models.Job {
	...
	return models.Job{
		...
		PostedAt: r.PostedAt, Score: score, Reason: reason, Eligibility: elig,
